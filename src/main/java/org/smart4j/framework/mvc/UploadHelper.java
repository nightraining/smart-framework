...
import org.smart4j.framework.mvc.dault.UploadException;
    ...
    public static List<Object> createMultipartParamList(HttpServletRequest request) throws Exception{
        ...
        for (FileItem fileItem : fileItemList){
            ...
            if (fileItem.isFormField()){
                ...
                // 处理文件字段
                String fileName = FileUtil.getRealFileName(fileItem.getFieldName());
        ...
        // 初始化参数列表
        paramList.add(new Params(fileMap));
